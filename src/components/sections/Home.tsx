          ...
          <div className="space-y-8">
            <div className="space-y-2">
              ...
              <h1 className="text-5xl md:text-6xl font-bold text-gray-900">
                Hi, I'm <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600">Dish khant</span>
              </h1>
            </div>
            <p className="text-xl text-gray-600">
              A passionate React JS Developer crafting beautiful and functional web experiences
            </p>
